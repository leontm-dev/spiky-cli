...
| Option | Description                                               |
| :----- | :-------------------------------------------------------- |
| `-y`   | _Optional_. Skips the prompts and uses the default values |
...
| :------------ | :------------------------------------------------- |
| `--overwrite` | _Optional_. Enables instant overwriting            |
| `--keeplines` | _Optional_. Keeps the lines of your spiky.js code. |
...
| `export`        | object | _Required_. An object that sets different export settings.                    |
...
| `formatOutput`      | boolean           | _Required_. Enable format settings                                                                                                 |
| `formatterSettings` | boolean           | _Optional_. Only available if formatOutput=true. For options: [check here](https://www.npmjs.com/package/@wasm-fmt/ruff_fmt#Usage) |
...
| :----------- | :---------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `type`       | python or project | **Required**.                                                                                                                                           |
| `folderName` | string            | _Required_. The path to the folder that holds your existing project. If this path is not reachable, a new folder with projectbody.json will be created. |
